...
public class ThirdScene: SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
		add_entity(SESpriteEntity.for_color(Color.instance("#339900"), get_scene_width(), get_scene_height()));
		...
		colormain.move(0.75*get_scene_width(),0.80*get_scene_height());
		...
		textmain.move(0.75*get_scene_width(), 0.8*get_scene_height());
