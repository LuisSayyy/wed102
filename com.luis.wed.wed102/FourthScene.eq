...
public class FourthScene: SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
		add_entity(SESpriteEntity.for_color(Color.instance("#FFCC33"), get_scene_width(), get_scene_height()));
		...
		colormain.move(0.75*get_scene_width(),0.9*get_scene_height());

		rsc.prepare_font("myfont", "arial bold color=white", 40);
		textmain = add_sprite_for_text("main", "myfont");
		textmain.move(0.75*get_scene_width(), 0.9*get_scene_height());
