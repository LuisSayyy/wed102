...
public class FirstScene: SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
		add_entity(SESpriteEntity.for_color(Color.instance("#FF0000"), get_scene_width(), get_scene_height()));
		colormain = add_sprite_for_color(Color.instance("#000000"), 0.25*get_scene_width(), 0.25*get_scene_height());
		colormain.move(0.75*get_scene_width(), 0.6*get_scene_height());

		color2 = add_sprite_for_color(Color.instance("#0000FF"), 0.25*get_scene_width(), 0.25*get_scene_height());
		color2.move(0.75*get_scene_width(),0.7*get_scene_height());

		color3 = add_sprite_for_color(Color.instance("#339900"), 0.25*get_scene_width(), 0.25*get_scene_height());
		color3.move(0.75*get_scene_width(),0.8*get_scene_height());
		...
		textmain.move(0.75*get_scene_width(), 0.6*get_scene_height());
	...
	public void on_pointer_press(SEPointerInfo pi) {
		...
		if(pi.is_inside(0.75*get_scene_width(), 0.6*get_scene_height(), get_scene_width(), 0.6*get_scene_height())) {
